...
if (ACTION_READY.equals(intent.getAction())){

   // ArrayList<String> listUrl = FirebaseDatabase.getInstance().getReference().child("audio").getKey()
}
